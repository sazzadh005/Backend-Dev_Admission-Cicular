...
<div class="container mx-auto py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white shadow rounded-lg flex items-center p-6">
            <div class="mr-4">
                <span class="bg-purple-500 text-white rounded-full p-4">
                    <i class="fas fa-file-signature fa-2x"></i>
                </span>
            </div>
            <div>
                <h5 class="text-gray-500 mb-1 font-semibold">Total Applications</h5>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Recent Applications -->
        <div class="bg-white shadow rounded-lg">
            <div class="bg-purple-500 text-white rounded-t-lg px-6 py-3 font-bold flex justify-between items-center">
                <span>Recent Applications</span>
                @if($applications->count() > 10)
                <a href="{{ route('applications.index') }}" class="text-sm text-white hover:underline">View All</a>
                @endif
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Univeristy</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($applications->take(10) as $app)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $loop->iteration }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 text-center text-gray-500">No applications found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
